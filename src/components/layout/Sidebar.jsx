...
function LogoSidebar({ isDark }) {
  const color = isDark ? '#ffffff' : '#0a0a0a'
  return (
    <svg width="110" height="9" viewBox="0 0 751 62" fill="none" xmlns="http://www.w3.org/2000/svg"
      style={{ width: 110, height: 'auto', maxWidth: '100%', display: 'block' }}>
