-- Rollback de 20260902220019_get_encuestas_encuestador_fallback_zona.sql
-- Restaura la versión anterior, que exigía JOIN encuestas_equipo en ambas ramas.
...
begin
  if v_rol = 'coordinador' then
    ...
    join encuestas_equipo ee on ee.equipo_id = ec.equipo_id
    join encuestas e on e.id = ee.encuesta_id
    join encuesta_zonas ez on ez.encuesta_id = e.id and ez.equipo_id = ec.equipo_id
    ...
    join encuestas_equipo eet on eet.equipo_id = ee.equipo_id
